...
from research_agent.database import save_research_to_db
...
database_agent = Agent(
    ...
    1. Use the 'topic' for 'topic' field in DB.
    2. Use the 'sources' list for 'sources' field in DB.
    3. Use the 'full_text_markdown' as the 'report' field in DB.
